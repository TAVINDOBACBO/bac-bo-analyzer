...
# Configurações
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "8606932768:AAHOqammF-KDSG_WnHdXyf4Hq92gLx_XUGs")
TELEGRAM_CHANNEL_ID = os.getenv("TELEGRAM_CHANNEL_ID", "-1003767539023")
...
SIGNAL_COOLDoWN_DURATIONWN_DURATION = 5
